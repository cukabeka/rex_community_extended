...
INSERT INTO `rex_62_params` VALUES 
  ...
  (11,'translate:com_board_perm','art_com_boardtype',12,'',3,'','0:translate:com_board_forallboards|1:translate:com_board_inallboards|2:translate:com_board_inoneboard|3:translate:com_board_noboards','','admin',1370880713,'',0),
  (12,'translate:com_board_name','art_com_boards',13,'multiple=multiple',3,'','select name as label,id from rex_com_board order by label','','admin',1370880713,'',0),
  ...
  (15,'translate:com_permtype','art_com_permtype',11,'',3,'','0:translate:com_perm_extends|1:translate:com_perm_only_logged_in|2:translate:com_perm_only_not_logged_in|3:translate:com_perm_all','','admin',1370880484,'',0);
...
INSERT INTO `rex_article` VALUES 
  ...
  (11,11,5,'Meine Kontakte','Meine Kontakte',1,'',1,1,'|2|5|',0,1212051079,1212159056,0,0,'admin','admin',0,'','','','','','','','','','','','','',''),
  (12,12,5,'Angefragte Kontakte','Angefragte Kontakte',2,'',1,1,'|2|5|',0,1212051086,1212159215,0,0,'admin','admin',0,'','','','','','','','','','','','','',''),
  (13,13,5,'Zu best&#x2030;tigende Kontakte','Zu best&#x2030;tigende Kontakte',3,'',1,1,'|2|5|',0,1212051094,1212159204,0,0,'admin','admin',0,'','','','','','','','','','','','','',''),
  (14,14,3,'Basisdaten','Basisdaten',1,'',1,1,'|2|3|',0,1212051113,1212186242,0,0,'admin','admin',0,'','','','','','','','','','','','','',''),
  (15,15,3,'Kontaktdaten','Kontaktdaten',2,'',1,1,'|2|3|',0,1212051120,1212163681,0,0,'admin','admin',0,'','','','','','','','','','','','','',''),
  (16,16,3,'Passwort','Passwort',4,'',1,1,'|2|3|',0,1212051128,1212154670,0,0,'admin','admin',0,'','','','','','','','','','','','','',''),
  (17,17,3,'Pers&#x02c6;nliches','Pers&#x02c6;nliches',3,'',1,1,'|2|3|',0,1212051134,1212160581,0,0,'admin','admin',0,'','','','','','','','','','','','','',''),
  (18,18,3,'G&#x2030;stebuch','G&#x2030;stebuch',5,'',1,1,'|2|3|',0,1212051141,1212161489,0,0,'admin','admin',0,'','','','','','','','','','','','','',''),
  ...
  (24,24,22,'Registrierung','Registrierung',2,'',1,1,'|22|',0,1212052232,1212152949,1,0,'admin','admin',0,'','','','','','','','','','','','','',''),
  (25,25,22,'Passwort vergessen','Passwort vergessen',3,'',1,1,'|22|',0,1212052241,1212153113,1,0,'admin','admin',0,'','','','','','','','','','','','','',''),
  (26,26,24,'Registierungsbest&#x2030;tigung','Registrierung',0,'',0,2,'|22|24|',0,1212052257,1212149758,1,0,'admin','admin',0,'','','','','','','','','','','','','',''),
...
INSERT INTO `rex_article_slice` VALUES 
  ...
  (21,0,1,0,'4','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','3','','','','','','','','','','','','','','','','','','','','','',18,12,1212161489,0,'admin','',0,0),
...
INSERT INTO `rex_com_user` VALUES 
  (1,'test','test','','','test@test.de',1,'','','1370874253','','','','','');
...
DROP TABLE IF EXISTS `rex_hardy`;
CREATE TABLE `rex_hardy` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `rex_hardy` WRITE;
/*!40000 ALTER TABLE `rex_hardy` DISABLE KEYS */;
INSERT INTO `rex_hardy` VALUES 
  (1,'1','test','');
/*!40000 ALTER TABLE `rex_hardy` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `rex_xform_field` VALUES 
  (1,'rex_com_user',1,'value','text','login','translate:login','','0','','','','','',0,1),
  (2,'rex_com_user',2,'validate','empty','login','translate:com_please_enter_login','','','','','','','',1,0),
  (3,'rex_com_user',3,'validate','unique','login','translate:com_this_login_exists_already','rex_com_user','','','','','','',1,0),
  (4,'rex_com_user',4,'value','text','password','translate:password','','0','','','','','',1,1),
  (5,'rex_com_user',5,'validate','empty','password','translate:com_please_enter_password','','','','','','','',1,0),
  (6,'rex_com_user',6,'value','text','email','translate:email','','0','','','','','',0,1),
  (7,'rex_com_user',7,'validate','empty','email','translate:com_please_enter_email','','','','','','','',1,0),
  (8,'rex_com_user',8,'validate','email','email','translate:com_please_enter_email','','','','','','','',1,0),
  (9,'rex_com_user',9,'validate','unique','email','translate:com_this_email_exists_already','','','','','','','',1,0),
  (10,'rex_com_user',10,'value','select','status','translate:status','translate:com_account_requested=0,translate:com_account_active=1,translate:com_account_inactive=-1','0','-1','0','','','',0,1),
  (11,'rex_com_user',11,'value','text','firstname','translate:firstname','','0','','','','','',0,1),
  (12,'rex_com_user',12,'value','text','name','translate:name','','0','','','','','',0,1),
  (13,'rex_com_user',13,'value','text','activation_key','translate:activation_key','','0','','','','','',1,1),
  (14,'rex_com_user',14,'value','text','session_key','translate:session_key','','0','','','','','',1,1),
  (15,'rex_com_user',15,'value','datestamp','last_action_time','U','0','1','','','','','',1,1),
  ...
  (29,'rex_com_board',2,'validate','empty','name','translate:com_board_xform_enter_name','','','','','','','',1,0),
  (28,'rex_com_board',1,'value','text','name','translate:name','','0','','','','','',0,0),
  (30,'rex_com_user',19,'value','be_manager_relation','rex_com_board','translate:com_board_name','rex_com_board','name','1','1','','','',1,0),
  ...
  (24,'rex_com_user',20,'value','be_manager_relation','rex_com_group','translate:com_group_name','rex_com_group','name','1','1','','','',1,0),
  (25,'rex_com_user',16,'value','com_auth_password_hash','password_hash','password','','','','','','','',1,0),
  (26,'rex_com_user',17,'value','text','authsource','translate:com_auth_authsource','','','','','','','',1,0),
  (27,'rex_com_user',18,'value','text','facebookid','translate:com_auth_facebook_facebookid','','','','','','','',1,0);
...
INSERT INTO `rex_xform_table` VALUES 
  ...
  (2,1,'rex_hardy','Test','',50,10,1,0,1,1),
  (5,1,'rex_com_board','translate:com_board_name','',50,110,0,0,0,0),
