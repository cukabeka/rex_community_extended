...
CodeMirror.defineMode("xform", function(config) {
...
CodeMirror.defineMIME("text/x-xform", "xform");
if (!CodeMirror.mimeModes.hasOwnProperty("text/xform"))
  CodeMirror.defineMIME("text/xform", "xform");
