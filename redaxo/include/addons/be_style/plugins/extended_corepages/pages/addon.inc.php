...
$myparent   = implode(array_slice(explode('/',__FILE__), -5, 1));
...
echo '<style>'.rex_get_file_contents($myroot . 'assets/backend.css').'</style>';
echo '<script>'.rex_get_file_contents($myroot . 'assets/backend.js').'</script>';
