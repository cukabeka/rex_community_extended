...
$REX['ADDON']['version'][$mypage] = '4.5.0 (jdlx)';
$REX['ADDON']['author'][$mypage] = 'Jan Kristinus, jdlx (UI enhancements)';
...
if(version_compare($REX['VERSION'].'.'.$REX['SUBVERSION'].'.'.$REX['MINORVERSION'], '4.5.0', '<')) {
  include ($REX['INCLUDE_PATH'].'/addons/'.$mypage.'/classes/basic/compat/class.rex_xform_list.inc.php');
} else {
