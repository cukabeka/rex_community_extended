...
class rex_com_board
{
			...
			$mout .= '	<div class="com-topic">
							...
							<div class="com-content-2">
								...
								<p class="topic">
									...
									$this->getLink(array(
									  "bb_func" => "showMessage",
									  #"bb_msg_id" => $msql->getValue("rex_com_board.message_id")
									  "bb_msg_id" => $arr[$i]['message_id']
									  ))
									.'">';
	...
	function setLang($lang)
	{
		...
		}else
		{
			...
			$this->text[30] = "Neues Thema hinzufŸgen";
			$this->text[40] = "Themen";
			$this->text[45] = "Thema";
			$this->text[50] = "Autor";
			...
			$this->text[150]= "d M H:i";
			$this->text[155]= "h";
			$this->text[160]= "Antwort hinzufŸgen";
			$this->text[170]= "Keine Antworten";
			$this->text[180]= "Deine Antwort";
			$this->text[190]= "Antwort hinzufŸgen";
			$this->text[200]= "Bitte gib eine Antwort ein !";
			$this->text[210]= "Antwort wurde hinzugefŸgt";
			$this->text[220]= "Dieses Thema existiert nicht.";
			$this->text[230]= "Thema wurde hinzugefŸgt";
			$this->text[240]= "Du hast keine Themaüberschrift eingegeben. Thema wurde nicht hinzugefŸgt !";
			$this->text[250]= "Thema und Antworten wurden gelšscht !";
